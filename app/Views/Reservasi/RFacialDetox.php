...
<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Detail/FacialDetox">Facial Oksigen Detox</a></li>
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="container">
                        <div class="row flex shadow">
                            ...
                            <div class="col-8 my-3">
                                <h4 class="text-base md:text-lg text-gray-800 font-bold">Facial Oksigen Detox</h4>
                                <p class="text-sm md:text-base mb-auto line-clamp-4">Prosedur facial yang cocok untuk semua jenis kulit dengan mengkombinasikan rangkaian produk oksigen dengan teknologi ultra sound.</p><strong>Rp. 90.000</strong>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-6">
                <form>
                    <div class="flex flex-col p-5 bg-white shadow-lg relative max-w-[592px]">
                        <h2 class="text-xl md:text-4xl text-gray-800 mb-4">Reservasi Treatment</h2>
                        ...
                        <div class="flex mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Facial Oksigen Detox" aria-label="Disabled input example" disabled>
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Total Yang Harus Dibayar</label>
                                <input class="form-control" type="text" placeholder="Rp 90.000" aria-label="Disabled input example" disabled>
                            </div>
                        </div>
                        <a href="/Detail/FacialBasic" class="btn btn-secondary">Batal</a>
