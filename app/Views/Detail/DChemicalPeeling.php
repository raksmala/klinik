...
<head>
    ...
    <title>Double Chemical Peeling</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Chemical">Double Chemical Peeling</a></li>
    ...
    <div class="container mx-9 my-5">
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/img/DChemical peeling.jpg" class="card-img" alt="...">
                </div>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            <h5 class="card-title">DOUBLE CHEMICAL PEELING</h5>
                            <hr style="border-color: black;">
                            <p class="card-text">Prosedur facial yang cocok untuk semua jenis kulit dengan tindakan untuk memutihkan dan memicu eksfoliasi atau pengelupasan sel-sel kulit mati serta kotoran di kulit menggunakan bahan kimia khusus yang dioleskan di kulit.</p>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    <br><button type="button" class="btn btn-secondary" disabled>Rp. 200.000</button>
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RDChemicalPeeling') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
