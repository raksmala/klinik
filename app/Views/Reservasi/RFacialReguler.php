...
<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Detail/FacialReguler">Kembali</a></li>
            <li class="breadcrumb-item active" aria-current="page">Reservasi Facial Oksigen Reguler</li>
        </ol>
    </nav>
    <br>
    <div class="container">
                ...
                <div class="flex flex-col p-5 bg-white shadow-lg relative max-w-[592px]">
                    ...
                    <div class="container">
                        <div class="row flex shadow">
                            <div class="col-4 p-0">
                                <img src="/img/facialll.jpg" class="img-fluid" alt="...">
                            </div>
                            <div class="col-8 my-3">
                                <h4 class="text-base md:text-lg text-gray-800 font-bold">Facial Oksigen Reguler/h4>
                                    <p class="text-sm md:text-base mb-auto line-clamp-4">Facial dengan rangkaian perawataan oksigen botanical yang dikombinasi dengan
                                        serum oksigen dan spray oksigen murni berfungsi menyegarkan kulit,
                                        mencerahkan dan menjadikan kulit lebih sehat.</p><strong>Rp. 100.000</strong>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col p-5 bg-white shadow-lg relative max-w-[592px]">
                        ...
                        <div class="flex mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Facial Oksigen Reguler" aria-label="Disabled input example" disabled>
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Total Yang Harus Dibayar</label>
                                <input class="form-control" type="text" placeholder="Rp 100.000" aria-label="Disabled input example" disabled>
                            </div>
                        </div>
                        <a href="/Detail/FacialGold" class="btn btn-secondary">Batal</a>
                        <a href="/layout/RiwayatReservasi" class="btn btn-primary">Kirim Reservasi</a>
...
<script>
    ...
    $(document).ready(function() {
        $('#formTanggal').on('submit', function(e) {
            e.preventDefault();

            var tanggal = $('#tanggal').val();

            $.ajax({
                url: '/Reservasi/RFacialGold',
                type: 'POST',
                data: {
                    tanggal: tanggal
                },
