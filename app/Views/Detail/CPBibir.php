...
<head>
    ...
    <title>Chemical Peeling Bibir</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Chemical">Chemical Peeling Bibir</a></li>
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            <h5 class="card-title">CHEMICAL PEELING BIBIR</h5>
                            <hr style="border-color: black;">
                            <p class="card-text">Perawatan yang berfungsi mencerahkan warna bibir, mengangkat sel kulit mati, dan melembabkan bibir.</p>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    ...
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RCPBibir') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
