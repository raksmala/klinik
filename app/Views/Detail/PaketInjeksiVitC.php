...
<head>
    ...
    <title>Paket Injeksi Vitamin C Collagen</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Badan">Paket Injeksi Vitamin C Collagen</a></li>
    ...
    <div class="container mx-9 my-5">
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/img/injeksi vitC.jpg" class="card-img" alt="...">
                </div>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            <h5 class="card-title">PAKET INJEKSI VITAMIN C COLLAGEN</h5>
                            <hr style="border-color: black;">
                            <p class="card-text">Paket Treatment yang memasukkan vitamin c dan collagen murni ke dalam bagian bawah kulit secara langsung guna menghilangkan berbagai masalah kulit seperti bekas luka atau garis halus pada wajah dengan 8 kali tindakan injeksi.</p>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    <br><button type="button" class="btn btn-secondary" disabled>Rp. 600.000</button>
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RPaketInjeksiVitC') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
