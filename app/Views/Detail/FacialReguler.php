...
<head>
    ...
    <title>Facial Oksigen Regular</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Facial">Facial Oksigen Reguler</a></li>
    ...
    <div class="container mx-9 my-5">
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/img/facial oksigen reguler.jpg" class="card-img" alt="...">
                </div>
                <div class="col-sm-9">
                    <div class="row">
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    ...
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RFacialReguler') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
