...
<head>
    ...
    <title>Facial Oksigen Intensif</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Facial">Facial Oksigen Intensif</a></li>
    ...
    <div class="container mx-9 my-5">
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/img/facial oksigen intensif.jpg" class="card-img" alt="...">
                </div>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            ...
                            <p class="card-text">Facial dengan rangkaian perawataan oksigen botanical yang dikombinasi dengan
                                serum oksigen dan spray oksigen murni berfungsi menyegarkan kulit,
                                mencerahkan dan menjadikan kulit lebih sehat.</p>
                        </div>
                        ...
                        <div class="col-4 col-sm-6">
                            ...
                            <hr style="border-color: black;">
                            <ul>
                                <li style="text-align:justify">Meningkatkan sirkulasi darah pada kulit wajah</li>
                                <li style="text-align:justify">Meningkatkan produksi kolagen</li>
                                <li style="text-align:justify">Mengurangi tanda-tanda penuaan</li>
                                <li style="text-align:justify">Menghidrasi kulit</li>
                                <li style="text-align:justify">Menyamarkan noda dan bekas jerawat</li>
                            </ul>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    ...
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RFacialIntensif') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
