...
<head>
    ...
    <title>Chemical Peeling Ketiak</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Chemical">Chemical Peeling Ketiak</a></li>
        ...
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            <h5 class="card-title">CHEMICAL PEELING KETIAK</h5>
                            <hr style="border-color: black;">
                            <p class="card-text">Perawatan yang membantu mencerahkan kulit ketiak dan membantu mengangkat sel kulit mati.</p>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    <br><button type="button" class="btn btn-secondary" disabled>Rp. 130.000</button>
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RCPKetiak') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
