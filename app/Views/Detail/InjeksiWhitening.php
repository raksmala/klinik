...
<head>
    ...
    <title>Injeksi Whitening Premium</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Badan">Injeksi Whitening Premium</a></li>
    ...
    <div class="container mx-9 my-5">
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/img/injek whitening.jpg" class="card-img" alt="...">
                </div>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            <h5 class="card-title">INJEKSI WHITENING PREMIUM</h5>
                            <hr style="border-color: black;">
                            <p class="card-text">Prosedur kecantikan yang membuat kulit menjadi putih dengan cepat.</p>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    ...
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RInjeksiWhitening') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
