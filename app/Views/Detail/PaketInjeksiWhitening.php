...
<head>
    ...
    <title>Paket Injeksi Whitening Premium</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Badan">Paket Injeksi Whitening Premium</a></li>
    ...
    <div class="container mx-9 my-5">
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/img/injek premium.jpg" class="card-img" alt="...">
                </div>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            <h5 class="card-title">PAKET INJEKSI WHITENING PREMIUM</h5>
                            <hr style="border-color: black;">
                            <p class="card-text">Paket prosedur kecantikan yang membuat kulit menjadi putih dengan cepat dengan tindakan 2 x Injeksi Free 2 Injeksi Vitamin C Collagen.</p>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    <br><button type="button" class="btn btn-secondary" disabled>Rp. 700.000</button>
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RPaketInjeksiWhitening') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
