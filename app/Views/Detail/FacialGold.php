...
<head>
    ...
    <title>Facial Gold Snail Whitening</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Facial">Facial Gold Snail Whitening</a></li>
    ...
    <div class="container mx-9 my-5">
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/img/facial gold snail whitening.jpg" class="card-img" alt="...">
                </div>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            ...
                            <p class="card-text">Facial yang digunakan untuk mencerahkan, melembabkan dan menghidrasi kulit wajah menggunakan bahan yang mengandung ekstrak siput (snail extract) dan emas (gold).</p>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    ...
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RFacialGold') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
