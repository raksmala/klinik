...
<head>
    ...
    <title>Glowing Glass Skin Kulit Wajah</title>
</head>

<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Treatment/Glowing">Glowing Glass Skin Kulit Wajah</a></li>
    ...
    <div class="container mx-9 my-5">
        <div class="flex flex-col p-5 bg-white shadow relative max-w-[592px]">
            <div class="row">
                <div class="col-sm-3">
                    <img src="/img/glas skin.jpg" class="card-img" alt="...">
                </div>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-8 col-sm-6">
                            <h5 class="card-title">GLOWING GLASS SKIN KULIT WAJAH</h5>
                            <hr style="border-color: black;">
                            <p class="card-text">Prosedur treatment yang membuat kulit wajah bersih, kencang, dan seolah tak berpori dengan tindakan Facial + Chemical Peeling + blackdoll include masker peel off.</p>
                        </div>
            ...
            <div class="row detail-padding-price d-flex justify-content-center">
                <div class="col-md-8 my-5 text-center">
                    <br><button type="button" class="btn btn-secondary" disabled>Rp. 350.000</button>
                    <?php if (!empty(session()->logged_in)) { ?>
                        <a href="<?= base_url('Reservasi/RGlowingWajah') ?>" class="btn btn-primary">Reservasi</a>
                    <?php } else { ?>
