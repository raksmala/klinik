...
<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Detail/FacialGold">Kembali</a></li>
            <li class="breadcrumb-item active" aria-current="page">Reservasi Facial Gold Snail Whitening</li>
        </ol>
    </nav>
    <br>
    <div class="container">
                    ...
                    <div class="container">
                        <div class="row flex shadow">
                            ...
                            <div class="col-8 my-3">
                                <h4 class="text-base md:text-lg text-gray-800 font-bold">Facial Gold Snail Whitening</h4>
                                <p class="text-sm md:text-base mb-auto line-clamp-4">Facial yang digunakan untuk mencerahkan, melembabkan dan menghidrasi kulit wajah menggunakan bahan yang mengandung ekstrak siput (snail extract) dan emas (gold).</p><strong>Rp. 75.000</strong>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col p-5 bg-white shadow-lg relative max-w-[592px]">
                        ...
                        <div class="flex mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Facial Gold Snail Whitening" aria-label="Disabled input example" disabled>
                            </div>
                            <div class="mb-3">
